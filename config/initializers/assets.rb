...
Rails.application.config.assets.precompile += %w( gobmx-navbar/gobmx-navbar.html )
Rails.application.config.assets.precompile += %w( gobmx-footer/gobmx-footer.html )